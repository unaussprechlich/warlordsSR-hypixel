...
export const AQUAMANCER = new Average(0, 100000, 1);
export const AVENGER    = new Average(0, 90000, 1);
export const CRUSADER   = new Average(0, 90000 , 1);
export const PROTECTOR  = new Average(0, 100000, 1);
export const THUNDERLORD= new Average(0, 90000, 1);
export const SPIRITGUARD= new Average(0, 100000, 1);
export const EARTHWARDEN= new Average(0, 100000, 1);
